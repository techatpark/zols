...
import com.zols.branchmanager.BranchManager;
import com.zols.branchmanager.domain.Branch;
...
public class BranchManagerController {    
    ...
    public String edit(@PathVariable(value = "name") String name, Model model) {
        ...
        return "com/zols/datastore/branch";
    }
    ...
    public String listing() {
        return "com/zols/datastore/listbranches";
    }
