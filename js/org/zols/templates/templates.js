(function($) {
    ...
    $("#submitCategory").on("click", function() {
        ...
        if (categoryName) {
            $.ajax(
                    {
                        url: base_url + "/api/template_repositories/" + categoryName,
                        type: 'PUT',
            ...
            $.ajax(
                    {
                        url: base_url + "/api/template_repositories",
                        type: 'POST',
                        data: JSON.stringify(formData),
                        dataType: "json",
                        contentType: 'application/json'
    ...
    $("#submitLink").on("click", function() {
        ...
        if (linkName) {
            $.ajax(
                    {
                        url: base_url + "/api/templates/" + linkName,
                        type: 'PUT',
                        data: JSON.stringify(formData),
                        dataType: "json",
                        contentType: 'application/json'
    ...
    function editCategory() {
        $.ajax({
            url: base_url + "/api/template_repositories/" + $category.val(),
            dataType: 'json',
            contentType: 'application/json'
    ...
    function loadLinksByCategory() {
        ...
        if (categoryName === '/') {
            ...
            $links.empty();
            $.ajax({
                url: base_url + "/api/template_repositories/" + categoryName+"/first_level_links",
                dataType: 'json',
                contentType: 'application/json'
            }).done(function(links) {
    ...
    function loadLinksByParent(parentLinkName) {
        $links.empty();
        $.ajax({
            url: base_url + "/api/templates/childen_of/" + parentLinkName,
            dataType: 'json',
            contentType: 'application/json'
        }).done(function(links) {
            createLinks(links);
